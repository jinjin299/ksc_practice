...
int main(int argc, char **argv) 
{
    ...
    cgsolver(matrixDOF[0], poissonmatrix[0], rhs[0], solution[0], maxiteration, tolerance, wrank, wsize);
    ...
    for(ii=1; ii<nlevel; ii++)
    {
        ...
        cgsolver(matrixDOF[ii], poissonmatrix[ii], rhs[ii], solution[ii], maxiteration, tolerance, wrank, wsize);
