...
int main(int argc, char **argv) 
{
    ...
    // Push Pointer
    for(ii=0; ii<nlevel; ii++) 
        poissonmatrix[ii] += matrixDOF[ii]/wsize * wrank;
    ...
    for(ii=1; ii<nlevel; ii++)
    {
        ...
        // Push Pointer
        solution[ii] += matrixDOF[ii]/wsize;
